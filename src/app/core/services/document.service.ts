...
//   ingestDocument(docId: number): Observable<any> {
//     return this.http.post(`${this.baseUrl}/documents/${docId}/ingest/`, {});
//   }

//   uploadAndIngest(file: File): Observable<any> {
//     return this.uploadDocument(file).pipe(
//       switchMap((uploadRes: any) => {
//         const docId = uploadRes.data.id;
//         return this.ingestDocument(docId);
//       })
//     );
//   }
// }